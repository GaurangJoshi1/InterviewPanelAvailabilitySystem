...
describe('SigninComponent', () => {
  ...
  beforeEach(() => {
    let authServiceSpyObj = jasmine.createSpyObj('AuthService', ['signIn','getUserId'])
  ...
  it('should navigate to home when user signs in successfully', () => {
    ...
    const mockUserIdResponse: ApiResponse<string> = {
      data: 'fakeToken',
      success: true,
      message: ''
    }
    ...
    authServiceSpy.getUserId.and.returnValue(of("3"))
